...
func TestClassifyDomain(t *testing.T) {
	cases := []struct {
		...
		{"web/src/modes/CreatorMode.jsx", DomainOrchestration},
		...
		{"internal/orchestration/evaluator.go", DomainOrchestration},
		{"internal/handlers/session_orchestration.go", DomainOrchestration},
		{"internal/database/orchestration_recommendations.go", DomainOrchestration},
