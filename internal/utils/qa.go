...
4b. (SCRUM-573) Rule 4 ONLY applies when the context establishes an explicit, closed enumeration of the relevant set (e.g. "the first five primes are 2, 3, 5, 7, 11" — completeness is stated). When the question asks about a SPECIFIC numeric value, date, or named entity (e.g. "Does the fixture include a $3.0M budget?", "Was the launch in Q3 2026?", "Is Alex the project lead?") and the context states a DIFFERENT specific value of the same kind WITHOUT establishing it as the only such value (e.g. context says "$2.4M proposed", "launch in Q4 2026", "Priya leads the project"), you MUST use answer_status="not_covered". In answer_text, state plainly that the questioned value is not covered AND quote the contradicting value from the context (e.g. "The fixture does not mention a $3.0M APAC budget. The context states the APAC budget was proposed at $2.4M."). Do NOT assert the questioned value is absent or present — the context's single-value statement is not proof of completeness. Citations still required.
