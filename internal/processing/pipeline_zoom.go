// SCRUM-409: Zoom pipeline file. runZoomJob and its Zoom-only helpers moved
// here from pipeline.go so the file structure mirrors pipeline_google_meet.go
// and pipeline_teams.go. Pure file move — behavior unchanged.
package processing
