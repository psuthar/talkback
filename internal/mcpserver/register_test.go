...
func TestToolNames(t *testing.T) {
	...
	if got := ToolNames(RegisterConfig{DB: &stubDB}); !slices.Equal(got, []string{ToolHealthCheck, ToolGetSessionMetadata, ToolGetSessionDecisions, ToolGetDecisions, ToolGetSessionActionItems, ToolGetActionItems, ToolSearchSession, ToolSearchSessionContent, ToolGetSessionRawChunks, ToolGetSessionRetrievalContext, ToolGetSessionSourceChunks, ToolAskSession, ToolAskSessionQuestion}) {
