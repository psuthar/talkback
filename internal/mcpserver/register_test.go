...
func TestToolNames(t *testing.T) {
	...
	if got := ToolNames(RegisterConfig{DB: &stubDB}); !slices.Equal(got, []string{ToolHealthCheck, ToolGetSessionMetadata, ToolSearchSession, ToolSearchSessionContent, ToolGetSessionRawChunks, ToolGetSessionRetrievalContext, ToolGetSessionSourceChunks, ToolAskSession, ToolAskSessionQuestion}) {
