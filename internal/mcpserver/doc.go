...
//
// Session DB tools (SCRUM-39, SCRUM-55, SCRUM-43, SCRUM-45, SCRUM-46, SCRUM-44, SCRUM-49): when DATABASE_URL is set, [Register] mounts get_session_metadata, get_session_decisions,
...
//     get_session_metadata, get_session_decisions, search_session, search_session_content, get_session_raw_chunks, get_session_retrieval_context, get_session_source_chunks, ask_session, and ask_session_question when DATABASE_URL is configured — SCRUM-39, SCRUM-55, SCRUM-43, SCRUM-48, SCRUM-45, SCRUM-52, SCRUM-46, SCRUM-44, SCRUM-49, SCRUM-50, SCRUM-54).
