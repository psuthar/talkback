...
//
// Session DB tools (SCRUM-39, SCRUM-43): when DATABASE_URL is set, [Register] mounts get_session_metadata
// and search_session_content, which use [github.com/psuthar/talkback/internal/database] and the same access
...
//     get_session_metadata and search_session_content when DATABASE_URL is configured — SCRUM-39, SCRUM-43).
