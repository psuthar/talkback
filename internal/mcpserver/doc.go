...
//     get_session_metadata, search_session, search_session_content, get_session_retrieval_context, get_session_source_chunks, and ask_session_question when DATABASE_URL is configured — SCRUM-39, SCRUM-43, SCRUM-48, SCRUM-45, SCRUM-46, SCRUM-44).
