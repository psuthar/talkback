...
//
// Session DB tools (SCRUM-39, SCRUM-43, SCRUM-45, SCRUM-46, SCRUM-44, SCRUM-49): when DATABASE_URL is set, [Register] mounts get_session_metadata,
// search_session, search_session_content (alias), get_session_retrieval_context, get_session_source_chunks, ask_session, ask_session_question (alias), which use [github.com/psuthar/talkback/internal/database] and the same access
...
//     get_session_metadata, search_session, search_session_content, get_session_retrieval_context, get_session_source_chunks, ask_session, and ask_session_question when DATABASE_URL is configured — SCRUM-39, SCRUM-43, SCRUM-48, SCRUM-45, SCRUM-46, SCRUM-44, SCRUM-49, SCRUM-50).
